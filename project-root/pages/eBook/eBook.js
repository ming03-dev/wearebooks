...
// books 배열에서 isBest === true, type === "ebook"인 책만 골라서 새 배열을 만듦
const bestsellerBooks = books.filter(
  book => book.isBest && book.type === "ebook"
); 
...
// 책 목록 부분
const categories = [
  { name: "건강 취미 여행", key: "health" },
  { name: "국어 외국어", key: "language" },
  { name: "자기계발", key: "develop" }
];
